          ...
          <div className="md:w-[50%] ">
            {session?.user ? (
              <>
                <div className="mt-8 flex flex-col justify-center   items-center">
                  <p className="text-lg lg:max-w-[70%] text-center">
                    If you bored to think what to cook everyday, jump in your
                    kitchen and start adding recipes!
                  </p>
                </div>
                <div className="flex justify-center mt-4 md:ml-[30%] lg:mr-40 items-center gap-5">
                  ...
                  <Link href={`/my-kitchen/${session.user.username}`}>
                    <button className="bg-[#D34C26] text-white rounded-[16px] w-44 mt-3 text-center py-1 cursor-pointer">
                      My Kitchen
                    </button>
                  </Link>
                </div>
              ...
              <>
                <div className="mt-8 flex flex-col justify-center   items-center">
                  <p className="text-lg lg:max-w-[70%] text-center">
                    If you bored to think what to cook everyday, register and
                    solve your problem!
                  </p>
                </div>
                <div className="flex justify-center mt-4 md:ml-[30%] lg:mr-40 items-center gap-5">
